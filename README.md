...
1. **Manual Setup:**
   ...
   sudo -u postgres psql -f supabase/migrations/20250626121547_violet_tree.sql
   
   # Run schema and seed data
   psql -d restaurant_db -U restaurant_user -f supabase/migrations/20250626121551_foggy_swamp.sql
   psql -d restaurant_db -U restaurant_user -f supabase/migrations/20250626121612_lingering_darkness.sql
   ```
